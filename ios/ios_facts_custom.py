...
class Interfaces(FactsBase):
    ...
    def populate(self):
        ...
        cdp_errs = ['Invalid input', 'CDP is not enabled']    
        ...
        if data:
            ...
            for resp in responses:
                if resp.find("Interface") == 0:
                    ...
                    pre = 'FastEthernet'
                port = pre + resp.split()[0][2:]
                vrf = resp.split()[2]
                self.facts['interfaces'][port].update({'vrf' : vrf})
    ...
    def parse_neighbors_cdp(self, data):
        objects = dict()
